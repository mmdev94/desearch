...
def solve_recaptcha_v2_invisible(
    *,
    ...
    """
    Solve reCAPTCHA v2 invisible via 2Captcha API v2.

    Task type: RecaptchaV2TaskProxyless with isInvisible=true.
    ...
    while time.time() < end:
        ...
        if status == "ready":
            ...
            return RecaptchaV2Solution(token=token, task_id=str(task_id))
